      ...
      <div className="navbar">
        ...
        : 
          <>
              ...
              <Avatar backgroundColor="#009dff" px="10px" py="8px" borderRadius="50%" color="white"> <Link style={{textDecoration:'none'}} to={`/Users/${User?.result?._id}`} > {User.result.name.charAt(0).toUpperCase()} </Link></Avatar>
